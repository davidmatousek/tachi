...
#   --version <tag>  Install files from a specific tagged version (e.g., v4.41.0) # x-release-please-version
#   --help           Show this usage information
#
# Examples:
#   cd ~/Projects/my-app && ~/Projects/tachi/scripts/install.sh
#   ./install.sh --source ~/Projects/tachi
#   ./install.sh --version v4.41.0 # x-release-please-version
...
usage() {
  ...
  echo "  --version <tag>  Install files from a specific tagged version (e.g., v4.41.0)" # x-release-please-version
