...
- [CI/CD Guide](CI_CD_GUIDE.md) — includes manifest-coverage + extract-coverage + stack-contract workflows, tachi-pytest (F-248 + F-256 + F-282 + F-302) + tachi-mmdc-preflight (F145) + gitleaks (F-282 / F-5) + tachi-maestro-coverage (F-315 / #313) host-runner workflows, bash:3.2 Docker pattern, BATS harness, update-script env vars
