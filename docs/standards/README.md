...
| [OWASP_COVERAGE.md](OWASP_COVERAGE.md) | OWASP five-framework coverage matrix (50/50) — canonical anchor, reproducibility recipe, anti-claims |
...
| [PUBLISHING_SECURITY.md](PUBLISHING_SECURITY.md) | Security, privacy, Rust validation, and GitHub hygiene checklist for public pushes and release preparation |
