...
- **Tasks**
  ...
  - scope placeholder substitution to manifest-backed `personalized` files and shipped `.aod/templates/` files instead of walking the whole tree
