...
- **Tasks**
  ...
  - remove Python-specific install guidance from active docs, including pre-commit installation wording and pytest examples in organization docs
