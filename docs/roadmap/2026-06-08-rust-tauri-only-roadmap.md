...
- **Tasks**
  ...
  - remove Python-specific install guidance from active docs, including pre-commit installation wording, pytest examples in organization docs, and pip-install wording in permissions docs
