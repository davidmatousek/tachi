...
- FastAPI backend Alembic scaffold directories (`scaffold/backend/alembic` and `scaffold/backend/alembic/versions`) plus their packaging manifests have been retired from both `stacks/fastapi-react/` variants
