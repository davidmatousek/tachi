...
| RT-014 | Pending | Start after RT-012 and RT-013 prove the Python packaging and scaffold surfaces can be archived as legacy references; the smoke guide and live doc JSON examples now point at Rust/Tauri or shell tooling, and the security-review FastAPI scaffold note is archived guidance only. |
