...
| Report-data generation port | Backlog | In progress | Remediation-action selection now lives in `tachi-core`, and threat/risk SARIF emitters are now Rust-backed |
