...
**Target Platform**: GitHub-hosted repo (`github.com/pratik-saptarshi/tachi-rust`); read by humans on web (Security tab), in IDE clones, and via `make update`.
...
40:## Community
44:- **Security vulnerabilities** → [private advisory](https://github.com/pratik-saptarshi/tachi-rust/security/advisories/new) (do not post publicly)
```
...
| `https://github.com/pratik-saptarshi/tachi-rust/security` | Visit page (read-only) | (out of tree) | FR-011 [MANUAL-ONLY] | Manual UI inspection: *Report a vulnerability* button visible |
| `https://github.com/pratik-saptarshi/tachi-rust/security/advisories/new` | Visit page (read-only smoke test; no submit) | (out of tree) | FR-012 [MANUAL-ONLY] | Form loads; no 404; no submission |
...
- Primary instruction: *"Use the **Report a vulnerability** button on the [Security tab](https://github.com/pratik-saptarshi/tachi-rust/security) of this repo."*
- Fallback: *"Or navigate directly to `https://github.com/pratik-saptarshi/tachi-rust/security/advisories/new` to open a private advisory."*
...
- Threat-model accuracy concerns (false positives, missed threats) → file as regular [GitHub Issues](https://github.com/pratik-saptarshi/tachi-rust/issues), not security advisories
...
2. **Visit Security tab** at `https://github.com/pratik-saptarshi/tachi-rust/security` — confirm *Report a vulnerability* button is visible.
3. **Smoke-test advisory URL** at `https://github.com/pratik-saptarshi/tachi-rust/security/advisories/new` — confirm form loads; do NOT submit.
