...
- [X] T020 Final gate: full `/usr/bin/python3 -m pytest tests/ -q` green; `/aod.analyze` clean (SC-006); quickstart.md §0–§6 walkthrough re-run clean; push branch; update draft PR #328 description with counts (records 53→N, edges 578→M, baselines 6, suite red→green) and evidence links
