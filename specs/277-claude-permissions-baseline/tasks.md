...
- [X] T023 Verify a release-please PR opens within ~30 seconds of the squash-merge per FR-013: `gh pr list --state open --search "release-please" --limit 3`. **If empty**, push an empty release-marker commit per the F-212 recovery flow:
  ```bash
