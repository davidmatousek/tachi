<!--
  ...
  1. Replace all tachi with your project name
  2. Replace threat modeling sidecar with your project description
...
- **Database**: PostgreSQL (e.g., PostgreSQL, MySQL)
- **Vector Search**: Not yet defined (e.g., pgvector, Pinecone, Qdrant)
...
- **Authentication**: Not yet defined (e.g., JWT, OAuth2)
...
- `tachi`: Your project name (e.g., "my-saas-platform")
- `threat modeling sidecar`: Brief description of what your project does

**Step 2: Replace Technology Stack**
- `PostgreSQL`: Your database choice (PostgreSQL, MySQL, MongoDB, etc.)
- `Not yet defined`: Your vector search solution (pgvector, Pinecone, Qdrant, etc.)
