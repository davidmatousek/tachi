...
This partial table intentionally lists only 3 of the 7 canonical MAESTRO layers
(L1, L3, L5) so the extractor's FR-003 backfill must synthesize the 4 absent
layers (L2, L4, L6, L7) at finding_count 0. Drives the mixed-count assertion
layers_with_findings=3 / empty_layers=4 / layer_count=7.

| MAESTRO Layer | Finding Count | Highest Severity |
|---|---|---|
| L1 — Foundation Model | 12 | Critical |
| L3 — Agent Framework | 6 | High |
| L5 — Evaluation and Observability | 3 | Medium |
