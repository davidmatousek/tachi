...
description: "AI/LLM prompt injection threat agent — detects direct and indirect prompt injection, jailbreak, system prompt extraction, and cross-plugin injection threats against LLM-integrated Processes."
