...
description: "AI/LLM data poisoning threat agent — detects threats where attackers manipulate training data, RAG indexes, knowledge bases, or fine-tuning pipelines to corrupt LLM behavior at the source."
