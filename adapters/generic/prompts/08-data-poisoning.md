...
This is a standalone threat analysis prompt for the **Data Poisoning** threat category.

**Input**: Provide the architecture components assigned to this agent by the orchestrator (from Step 8 of `00-orchestrator.md`).
