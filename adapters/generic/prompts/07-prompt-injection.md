...
This is a standalone threat analysis prompt for the **Prompt Injection** threat category.

**Input**: Provide the architecture components assigned to this agent by the orchestrator (from Step 7 of `00-orchestrator.md`).
