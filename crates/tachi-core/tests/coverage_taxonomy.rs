...
use tachi_core::coverage_taxonomy::{
    maestro_layer_catalog, owasp_coverage_family_catalog, render_owasp_coverage_matrix,
};
...
fn maestro_layer_catalog_lists_the_canonical_layer_names_in_order() {
    ...
    assert_eq!(catalog[4].layer_name, "Security");
    assert_eq!(catalog[5].layer_name, "Agent Ecosystem");
    assert_eq!(catalog[6].layer_name, "User Interface");
}
