...
```bash
~/Projects/tachi/scripts/install.sh --version v4.43.0 # x-release-please-version
```
...
To install a specific version: `install.sh --version v4.43.0` <!-- x-release-please-version -->
