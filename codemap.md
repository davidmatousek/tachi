...
| Coverage | `make llvm-cov` is the release-quality local gate. Current validated baseline: 87.93% regions / 88.11% lines. Current audit: 64 active modules, 57 Rust integration modules, 0 Python unit modules, 0 Python smoke modules, 6 support/regression modules. |
