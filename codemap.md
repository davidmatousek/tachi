...
| Integration | Rust integration tests under `crates/*/tests` and `src-tauri/tests`; current audit shows 42 Rust integration modules after retiring the template-config integration pytest. |
