...
| Coverage | `make llvm-cov` is the release-quality local gate. Current validated baseline: 86.36% regions / 86.73% lines. Current audit: 71 active modules, 69 Rust integration modules, 0 Python unit modules, 1 Rust smoke module, 0 support/regression modules. |
