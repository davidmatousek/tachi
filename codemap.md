...
| Coverage | `make llvm-cov` is the release-quality local gate. Current validated baseline: 86.41% regions / 86.76% lines. Current audit: 64 active modules, 58 Rust integration modules, 0 Python unit modules, 0 Python smoke modules, 5 support/regression modules. |
