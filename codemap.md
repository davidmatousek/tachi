...
| Coverage | `make llvm-cov` is the release-quality local gate. Current validated baseline: 86.47% regions / 86.84% lines. Current audit: 64 active modules, 59 Rust integration modules, 0 Python unit modules, 0 Python smoke modules, 4 support/regression modules. |
