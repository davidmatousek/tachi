...
| Smoke | Transitional smoke modules tracked by `tachi-core::coverage_audit`. |
...
| Coverage | `make llvm-cov` is the release-quality local gate. Recent validated baseline: 85.24% regions / 85.99% lines. |
